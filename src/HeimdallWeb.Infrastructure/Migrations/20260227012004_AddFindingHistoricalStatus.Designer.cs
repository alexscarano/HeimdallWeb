...
namespace HeimdallWeb.Infrastructure.Migrations
{
    ...
    [Migration("20260227012004_AddFindingHistoricalStatus")]
    partial class AddFindingHistoricalStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HeimdallWeb.Domain.Entities.Finding", b =>
                {
                    ...
                    b.Property<int?>("PresenteHaScans")
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("StatusHistorico")
                        .HasMaxLength(20)
            ...
            modelBuilder.Entity("HeimdallWeb.Domain.Entities.MonitoredTarget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("tb_monitored_target", (string)null);
                });

            modelBuilder.Entity("HeimdallWeb.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("tb_notification", (string)null);
                });

            modelBuilder.Entity("HeimdallWeb.Domain.Entities.RiskSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("MonitoredTargetId")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HeimdallWeb.Domain.Entities.ScanCache", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("tb_scan_cache", (string)null);
                });
            ...
            modelBuilder.Entity("HeimdallWeb.Domain.Entities.ScanProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("tb_scan_profile", (string)null);
                });
            ...
            modelBuilder.Entity("HeimdallWeb.Domain.Entities.RiskSnapshot", b =>
                {
                    b.HasOne("HeimdallWeb.Domain.Entities.MonitoredTarget", "MonitoredTarget")
                        .WithMany("RiskSnapshots")
                        .HasForeignKey("MonitoredTargetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HeimdallWeb.Domain.Entities.ScanHistory", "ScanHistory")
                        .WithMany()
                        .HasForeignKey("ScanHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MonitoredTarget");
            ...
            modelBuilder.Entity("HeimdallWeb.Domain.Entities.ScanHistory", b =>
                {
                    b.HasOne("HeimdallWeb.Domain.Entities.ScanHistory", "SourceHistory")
                        .WithMany()
