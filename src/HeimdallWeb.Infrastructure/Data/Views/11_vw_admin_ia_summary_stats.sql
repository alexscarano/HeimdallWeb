...
SELECT
    ...
    -- Últimas 24h
    SUM(CASE WHEN ia.created_date >= NOW() - INTERVAL '24 hours' THEN ia.findings_critical ELSE 0 END) AS critical_last_24h,
    SUM(CASE WHEN ia.created_date >= NOW() - INTERVAL '24 hours' THEN ia.findings_high ELSE 0 END) AS high_last_24h
